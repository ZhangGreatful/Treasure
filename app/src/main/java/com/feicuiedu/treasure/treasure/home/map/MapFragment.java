...
public class MapFragment extends MvpFragment<MapMvpView, MapPresenter> implements MapMvpView {
    ...
    // 点聚合管理类 ()
    private ClusterManager<CurtomClusterItem> clusterManager;
    ...
    private void initBaiduMap() {
        ...
        // -----------------------------------------------------------------------------------
        clusterManager = new ClusterManager<CurtomClusterItem>(getContext(), baiduMap);
        clusterManager.setRenderer(new CurtomClusterRenderer(getContext(),baiduMap,clusterManager));
    ...
    @Override public void setData(List<Treasure> data) {
        ...
        for (Treasure treasure : data) {
            ...
            clusterManager.addItem(new CurtomClusterItem(latLng, treasure.getId()));
        }
